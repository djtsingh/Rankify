...
export default function ScansContent() {
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-2">
            <span className="text-[#00e5d1]">Scheduled Scans</span>
          </h1>
          <p className="text-[rgba(255,255,255,0.5)]">
            Manage your automated website scanning schedule
          </p>
        </div>

        <div className="p-6 bg-gradient-to-b from-[#141a21] to-[#0e1318] border border-[rgba(255,255,255,0.06)] rounded-xl">
          <div className="flex items-center gap-3 mb-4">
            <Clock className="w-5 h-5 text-[#00e5d1]" />
            <h2 className="text-xl font-bold">Weekly Scans</h2>
          </div>
          <p className="text-[rgba(255,255,255,0.5)]">
            Set up automatic weekly scans for continuous monitoring
          </p>
        </div>
      </main>
      <Footer />
